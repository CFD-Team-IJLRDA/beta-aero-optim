...
def main():
    ...
    _, x_hf = mf_sampler.sample_mf(sm_config["optim"]["n_lf"], sm_config["optim"]["n_hf"])

    x_lf = copy.deepcopy(x_hf)
    ...
    for ite in range(nite):
        ...
        if os.path.isfile(os.path.join(outdir, f"model_{ite}.pkl")):
            ...
            # execute hf infill
            x_hf_infill = copy.deepcopy(x_lf_infill)
            ...
            x_lf_infill = copy.deepcopy(x_hf_infill)
            y_lf_infill = copy.deepcopy(y_hf_infill)
