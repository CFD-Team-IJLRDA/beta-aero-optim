...
def main():
    ...
    # input_dir = "../musicaa_RANSrerun/output/MUSICAA/musicaa_g0_c0/ADP"
    input_dir = "/home/mciarlatani/Irene/musicaa_RANSrerun/high_infill_3/MUSICAA/musicaa_g0_c0/OP1"
    output_key = "OP1"
    blocks_list = [1,2,3,4,5,6,7,8,9]
    blocks_list = [1,2,3,4,5,6,7,8,9]
    ...
    # Plot mesh
    print("Plotting mesh...")
    # plot_grid_paper(input_dir, True, blocks_list, every=1, figsize=figsize, airfoil_file=airfoil_file)
    plot_grid(input_dir, True, blocks_list, every=1, figsize=figsize, airfoil_file=airfoil_file)
